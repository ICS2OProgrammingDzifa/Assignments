...
--------------------------------------------------------------------------------------
-- Correct sound
local evilSound = audio.loadSound( "Sounds/evilSound.mp3" ) -- Setting a variable to an mp3 file
    ...
    creditsButton = widget.newButton( 
        {
            ...
            -- Insert the images here
            defaultFile = "Images/CreditsButtonUnpressedDzifaAgebyoh@2x.png",
            overFile = "Images/CreditsButtonPressedDzifaAgbenyoh@2x.png",
